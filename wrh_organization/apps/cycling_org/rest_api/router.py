...
rest_router.register(r'organization/(?P<org_id>[^/.]+)/event', views.OrganizationEventView,
                     basename='organization_event')
...
rest_router.register(r'global_pref', views.GlobalPreferencesView, basename='global_pref')
rest_router.register(r'panels', views.PanelsView)
