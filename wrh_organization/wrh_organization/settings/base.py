...
CKEDITOR_5_CONFIGS = {
    'default': {
        'toolbar': [
            "heading", "|", "outdent", "indent", "alignment", "|", "bold", "italic", "link", "underline", "strikethrough",
    ...
    'awesome': {
        ...
        'toolbar': [
            "heading", "codeBlock", "|", "outdent", "indent", "alignment", "|", "bold", "italic", "link", "underline",
...
CKEDITOR_5_STORAGE_BASE_PATH = 'uploads/ckeditor5/'
CKEDITOR_5_FILE_STORAGE = PUBLIC_FILE_STORAGE
...
USAC_API_USERNAME = '<USAC_API_USERNAME>'
USAC_API_PASSWORD = '<USAC_API_PASSWORD>'
